...
opts_chunk$set(fig.path = 'figs/', fig.align = 'center', fig.show = 'hold', message = F, dev = 'pdf', dev.args = list(family = 'serif'), fig.pos = '!ht', warning = F, cache = T, background = 'white', highlight = F, prompt = TRUE)
options(replace.assign = TRUE, digits = 1, prompt="R> ")
...
<<plotprune, eval = T, echo = T, fig.show = 'hold', fig.height = 7, fig.width = 7.7, out.width = '0.48\\textwidth', fig.cap = 'A pruned neural network from \\pkg{RSNNS} \\citep{Bergmeir12} using the ``Optimal Brain Surgeon\'\' algorithm described in \\citet{Zell98}.  The default plotting behavior of \\code{plotnet} is to omit pruned connections (\\ref{fig:plotprune1}), whereas they can be viewed as dashed lines by including the \\code{prune\\_col} argument (\\ref{fig:plotprune2}).', fig.subcap = c('', '')>>=
...
<<plotimp-1, fig.height = 2, fig.width = 4, out.width = '0.47\\textwidth', echo = F>>=
garson(mod1)
@
\label{fig:plotimp1}
}
\subfloat[][Model 1 (\code{mlp}), \code{olden}]{
<<plotimp-2, fig.height = 2, fig.width = 4, out.width = '0.47\\textwidth', echo = F>>=
olden(mod1)
@
\label{fig:plotimp2}
}
...
<<plotimp-3, fig.height = 2, fig.width = 4, out.width = '0.47\\textwidth', echo = F>>=
garson(mod2)
@
\label{fig:plotimp3}
}
\subfloat[][Model 2 (\code{nn}), \code{olden}]{
<<plotimp-4, fig.height = 2, fig.width = 4, out.width = '0.47\\textwidth', echo = F>>=
olden(mod2)
@
\label{fig:plotimp4}
}
...
<<plotimp-5, fig.height = 2, fig.width = 4, out.width = '0.47\\textwidth', echo = F>>=
garson(mod3)
@
\label{fig:plotimp5}
}
\subfloat[][Model 3 (\code{nnet}), \code{olden}]{
<<plotimp-6, fig.height = 2, fig.width =4, out.width = '0.47\\textwidth', echo = F>>=
olden(mod3)
@
\label{fig:plotimp6}
}
...
<<plotlek_sens1, fig.height = 2.5, fig.width = 8, out.width = '0.9\\textwidth', echo = F>>=
...
<<plotlek_sens2, fig.height = 2.5, fig.width = 8, out.width = '0.9\\textwidth', echo = F>>=
...
<<plotlek_bars1, fig.height = 2.5, fig.width = 8, out.width = '0.9\\textwidth', echo = F>>=
...
<<plotlek_bars2, fig.height = 2.5, fig.width = 8, out.width = '0.9\\textwidth', echo = F>>=
...
<<flightimp-1, fig.height = 3, fig.width = 8, out.width = '0.95\\textwidth', echo = F>>=
print(p1)
@
...
<<flightimp-2, fig.height = 3, fig.width = 8, out.width = '0.95\\textwidth', echo = F>>=
print(p2)
@
...
<<flightimp-3, fig.height = 3, fig.width = 8, out.width = '0.95\\textwidth', echo = F>>=
print(p3)
@
