...
<<plotlek_bars1, fig.height = 2.5, fig.width = 8, out.width = '0.8\\textwidth', echo = F>>=
...
<<plotlek_bars2, fig.height = 2.5, fig.width = 8, out.width = '0.8\\textwidth', echo = F>>=
